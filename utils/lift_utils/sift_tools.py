...
from utils.lift_utils.kp_tools import (IDX_ANGLE, IDX_OCTAVE, IDX_RESPONSE, IDX_SIZE,
...
if platform.system() == "Darwin":
    libSIFT = cdll.LoadLibrary("utils/lift_utils/libSIFT.dylib")
else:
    libSIFT = cdll.LoadLibrary('utils/lift_utils/libSIFT.so')
